...
public class EditCustomer extends javax.swing.JDialog {
    ...
    protected static CustomerScreen customerScreen;
    ...
    public void displayCustomerDetails() {
        ...
        firstNameField.setText(customer.getCustomerFirstName());
        lastNameField.setText(customer.getCustomerLastName());
        telField.setText(customer.getCustomerPhone());
    ...
    public void updateEditedCustomer(){
        ...
        Customer updatedCustomer = new Customer(customer.getCustomerID(), firstName, lastName, tel, email);
        int updateStatus = dbConnection.updateCustomer(updatedCustomer);
        
        //set table contents with updated values
        if(updateStatus > 0){
            CustomerScreen.dtm.setRowCount(0);
            ArrayList<Customer> customer = dbConnection.getAllCustomersDetails();
            CustomerScreen.populateCustomerTable(customer);
            customerScreen.clearDisplayLabels();
